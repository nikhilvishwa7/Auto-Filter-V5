...
BOT_TOKEN = environ.get('BOT_TOKEN', "5556712506:AAEx5o5qjWuOkKWdfOIuHBBlnLQ1Aqj4eMo")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001838392732').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://projectnv:projectnv421@cluster0.wieiqcz.mongodb.net/?retryWrites=true&w=majority")
...
# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001838392732))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001869437234))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/the_grey_man_in_hindi')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/howtodownnload/11')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001885467323))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001885467323))
